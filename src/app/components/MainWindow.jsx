        ...
        <div className="flex flex-col items-center justify-start min-h-screen p-4 md:p-8">
          ...
          <div className="w-full max-w-6xl terminal-border bg-black-150 backdrop-blur-sm overflow-hidden flex flex-col">
            ...
            <div className="flex flex-col">
              ...
              <div className="w-full p-6 md:p-10 border-b border-matrix/20">
                ...
                <div className="main-content mt-1">
                  ...
                  <div className="my-2">
                    ...
                    <p className="text-md mb-4 text-matrix opacity-70 leading-relaxed">
                      Welcome to the personal terminal database. Accessing
                      remote files... [OK]
                    </p>
                  </div>
                      ...
                      <div className="space-y-2">
                        {Object.entries(socials).map(([title, href], idx) => (
                          <a
                            ...
                            className="text-matrix text-lg flex items-center gap-2 group cursor-pointer hover:text-highlight-400 transition-colors"
                          >
                ...
                <div className="mt-6 text-matrix-dim ">
                  <h1 className="text-xl ">
                    💡Tip: Type a command or click on it to execute
                  </h1>
                </div>
              </div>
              ...
              <div
                id="terminal-section"
                className="w-full bg-black/40 flex flex-col max-h-auto overflow-hidden"
              >
                <Terminal />
              </div>
            </div>
