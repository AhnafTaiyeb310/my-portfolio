            ...
            <div className="w-[95%] h-full border-3 border-matrix">
                ...
                <div className="main-content my-4 mx-8">
                    <div className="headings">
                        ...
                        <h1 className="text-lg text-highlight-400"><span>NEW</span> Try <span className="link">Social-media</span></h1>
                    </div>

                    <div className="commands">
                        <h1 className="font-bold text-2xl my-4 text-highlight-400">Available Commands:</h1>
                        {
